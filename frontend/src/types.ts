...
export interface Settings {
  ...
  color: string
  /**
   * Set angleSnap to true if you want the shapes to snap to the closest angle (with 12.5 degree increments).
   * If you're using the KeyboardShortcuts tool you can use shift to temporarily turn on angleSnap.
   * @default false
   */
  angleSnap?: boolean
}
